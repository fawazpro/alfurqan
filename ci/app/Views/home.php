	        ...
	        <div class="inner_sec_info_agileits_w3">
	            ...
	            <div class="col-md-4 grid_info">
	                <div class="icon_info">
	                    ...
	                    <h5>Smell & Taste</h5>
	                    <p>Aboo Moosaa al-Asha'aree reported that the Prophet (&#xfdfa;) said, "The believer who recites the Qur'aan is like a citrus fruit - its fragrance is pleasing and its taste is sweet. The believer who does not recite the Qur'aan is like a dry date - it has no fragrance but its taste is sweet. The hypocrite who recites the Qur'aan is like a basil - its fragrance is sweet, but its taste is bitter. The hypocrite who does not recite the Qur'aan is like a colocynth - it has no smell, and its taste is bitter."</p>
	                </div>
	            </div>
	...
	<div class="banner-bottom">
	    <div class="container">
	        ...
	        <div class="inner_sec_info_agileits_w3">
	            ...
	            <p>
	                <ul class="some_agile_facts" style="font-family: 'Cairo', sans-serif; direction:rtl;">
	...
	<div class="features" id="features">
	    <div class="container">
	        <div class="tittle_head_w3layouts">
	            <h3 class="tittle">Studying is according to <span> one of the sessions below</h3>
	        </div>
	        <div class="inner_sec_info_agileits_w3">
	            <!-- <div class="border1"> -->
	            <div class="border">
